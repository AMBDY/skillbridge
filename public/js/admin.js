document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function loadLogistics() {
    const [providers, orders, templates, paymentProviders] = await Promise.all([API.get('/logistics/providers'), API.get('/orders/admin/all'), API.get('/orders/admin/templates'), API.get('/admin/payment-providers')]);
